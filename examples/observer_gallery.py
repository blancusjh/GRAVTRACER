...
"""
    ...
    (output / "observer_preview.html").write_text(
        ...
        "<style>body{margin:0;background:#000;color:#ece6da;font:17px/1.6 'STIX Two Text','Iowan Old Style','Palatino Linotype',Palatino,Georgia,'Times New Roman',serif}a{color:#f2b85a}</style>"
        + page
        + "</html>"
    )
